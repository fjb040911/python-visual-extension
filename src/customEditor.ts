...
export class CustomEditorProvider implements vscode.CustomTextEditorProvider {
	...
	private static readonly viewType = 'evasCustoms.csv';
	 ...
	 */
	// private async deleteItem(document: vscode.TextDocument, id: string) {
	// 	const json = await this.getDocumentAsJson(document);
	// 	if (!Array.isArray(json.items)) {
	// 		return;
	// 	}

	// 	json.items = json.items.filter((note: any) => note.id !== id);
	 ...
	 */
	private async getDocumentAsJson(document: vscode.TextDocument) {
	...
	private jsonParseToCsv(json: any) {
		try {
	...
	private updateTextDocument(document: vscode.TextDocument, json: any) {
		...
		const data: any = this.jsonParseToCsv(json);
