...
import { notificationData, formartEfromLayout } from '../libs/utils';
import { SOLUTION_ITEM_CLICK, events, methods, webDir } from '../constant';
...
class SolutionList {
    ...
    openPanel(solution: any) {
        ...
        const onReady = async (webView: vscode.Webview) => {
            ...
            newSolution = set(newSolution, 'eformData.layout', newFormDataLayout);
        ...
        this.openedViews[solution._id] = new WebviewDialog(solution._id, webDir, 'index.html', solution.name || nullName, this.generateMessageHandle('/solution', onReady), vscode.ViewColumn.One)
